            ...
            <div className='contenido-makeup'>
                ...
                <div className='atajos-makeup'>
                    <div className='atajo-1'>
                        <Link to='/ojos'  className='letra-atajos-makeup'>
                    ...
                    <div className='atajo-1'>
                        <Link to='/labios' className='letra-atajos-makeup'>
                    ...
                    <div className='atajo-1'>
                        <Link to='/piel' className='letra-atajos-makeup'>
                    ...
                    <div className='atajo-1'>
                        <Link to='/rostro' className='letra-atajos-makeup'>
