...
function Rostro() {
  const [rostros, setRostro] = useState([]);
  useEffect(() => {
            ...
            rostros?.map(rostro => (
              <div className="card" key={rostro.id}>
                ...
                <div className="text-card" id="product1">
                  ...
                  <div id={"modal" + rostro.id} className="modal"  >
                    ...
                    <div className="modalContainer" >
                      ...
                      <figure className="modalTEXT">
                        <h2 className="modalTitle">{rostro.producto}</h2>
                        <p className="modalP">{rostro.descripcion}
                        </p>
                        <div className="select-icon">
                          <select name="cantidad" id="cantidad">
                            <option value="0" defaultValue={0}>Cant.</option>
