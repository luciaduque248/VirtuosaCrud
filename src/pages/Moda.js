  ...
  return (
    <div>
      ...
      <section class="submenu2">
        ...
        <a href="#"> <button className='button-index-moda'>Diseña tu look</button></a>
      ...
      <section class="box-categoria" id="diseñatu" >
        <div class="ap-general">
          <div class="pr">
            <h1>Diseña tu look<br /><span>Productos personalizados</span></h1>
          </div>
          ...
          <div class="modalcomp">
            ...
            <div class="infomodal">
              <div class="imgBx">
                <img src="https://images.unsplash.com/photo-1622122201714-77da0ca8e5d2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" /></div>
              <div class="infomodalcomp">
                <h1>Diseña tu look</h1>
                ...
                <Link to="/VirtuosaCrud/moda-diseña"> <button className='button-index-moda'>Ver más</button></Link></div>
            </div>
          </div>
          ...
          <div class="box-menu">
            <div class="cardrp">
              <div class="imgBx">
                <img src="https://images.unsplash.com/photo-1622079400125-5b6679552976?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" /></div>
              <div class="details">
                <h3>Vestido largo Boho<br /><span>Woman Dress</span></h3>
                <h4>Product Details</h4>
                <p>vestido midi de manga corta luce una capa de tul semitransparente con falda larga</p>
                ...
                <div class="group">
                  <h2><sup>$</sup>100<small>.000</small></h2>
                  <Link to="/VirtuosaCrud/moda-diseña">Buy Now</Link>
                </div>
            ...
            <div class="cardrp">
              <div class="imgBx">
                <img src="https://images.unsplash.com/photo-1572123748421-ac758c94c4db?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="" /></div>
              <div class="details">
                <h3>Vestido largo Boho<br /><span>Woman Dress</span></h3>
                <h4>Product Details</h4>
                <p>vestido midi de manga corta luce una capa de tul semitransparente con falda larga</p>
            ...
            <div class="cardrp">
              <div class="imgBx">
                <img src="https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=446&q=80" alt="" /></div>
              <div class="details">
                <h3>Vestido largo Boho<br /><span>Woman Dress</span></h3>
                <h4>Product Details</h4>
                <p>vestido midi de manga corta luce una capa de tul semitransparente con falda larga</p>
